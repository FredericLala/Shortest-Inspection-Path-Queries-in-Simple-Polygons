...
#include "../../../vcpkg_installed/x64-windows/include/CGAL/Qt/GraphicsViewNavigation.h"
...
struct qt_meta_stringdata_CLASSCGALSCOPEQtSCOPEGraphicsViewNavigationENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCGALSCOPEQtSCOPEGraphicsViewNavigationENDCLASS = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCGALSCOPEQtSCOPEGraphicsViewNavigationENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject CGAL::Qt::GraphicsViewNavigation::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCGALSCOPEQtSCOPEGraphicsViewNavigationENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCGALSCOPEQtSCOPEGraphicsViewNavigationENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCGALSCOPEQtSCOPEGraphicsViewNavigationENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *CGAL::Qt::GraphicsViewNavigation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCGALSCOPEQtSCOPEGraphicsViewNavigationENDCLASS.stringdata0))
